      ...
      <div style={{ position: "relative" }}>
        ...
        <Row style={{ padding: "15px" }}>
          ...
          <Col xs="12" sm="6">
            ...
            <br />
            La palabra Kosher significa apto o adecuado en idioma hebreo. Los
            productos kosher son aquellos de acuerdo a normas dietéticas judías,
            las cuales las hace permisibles al consumo.
            <br />
          </Col>
        </Row>
        <Row>
          ...
          >
            ...
            >
              <Col xs="12" sm="6" className="p-5">
                <div className="icon-box-circle d-flex justify-content-center align-items-center">
                ...
                <div className="features-description">
                  Garantiza al consumidor integridad, naturaleza y calidad. El
                  sello Kosher no solo indica que la elaboración del producto se
                  rige bajo las normas de la religión judía, sino también la
                  estricta limpieza y saneamiento de los equipos de producción.
                </div>
              </Col>
              <Col xs="12" sm="6" className="p-5">
                <div className="icon-box-circle d-flex justify-content-center align-items-center">
                ...
                <div className="features-description">
                  Cumplimos con los más estrictos niveles de confidencialidad.
                  Somos extremadamente sensibles a las necesidades de la
                  compañias y respetamos las necesidad de la información y
        ...
        <Row>Slider de empresas que certifican</Row>
        <Row
          style={{
            color: "white",
            backgroundImage: "url(/img/skill-back.jpg)",
            minHeight: "250px",
            textAlign: "center",
        ...
        >
          <Col md="12">
            ...
            <h6>
              El amplio servicios de certificaciones Kosher que ofrecemos nos
              permite contar con empresas de mas diversos rubros alimenticios
            </h6>
            <br />
          </Col>
        ...
        <Row className="p-5 row d-flex justify-content-center">
          <Col
            md="9"
            className="pb-3"
            style={{ fontSize: "1rem", textAlign: "justify", fontWeight: 500 }}
          >
