...
export default class Empresas extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <UncontrolledCarousel controls={controls} items={items} className="row" />
                <div style={{position: 'absolute', top: '100px', width: '96.666%', color: '#FFF', textAlign:'center'}}>
                        <h2>Un Valor Agregado</h2>
                </div>
                ...
                <Row>
                    ...
                    >
                        ...
                        <Row style={{ minHeight:'200px', color:'white' }} >
                            <Col xs="12" sm="6" >
                            ...
                            <Col xs="12" sm="6">
                                DECLARACIÓN DE CONFIDENCIALIDAD <br/>
